...
* first model request sees only the builtin Minimal preset's exact one-tool surface
* (persistent `bash`; 0.1.5-rc.1 dropped `str_replace_editor` from Minimal), and after the anchor the
